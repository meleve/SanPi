...
class FacturasControllerTest < ActionController::TestCase
  ...
  test "should create factura" do
    assert_difference('Factura.count') do
      post :create, factura: { alumno_id: @factura.alumno_id, nro_fac: @factura.nro_fac, total: @factura.total, usuario_id: @factura.usuario_id }
    end
  ...
  test "should update factura" do
    patch :update, id: @factura, factura: { alumno_id: @factura.alumno_id, nro_fac: @factura.nro_fac, total: @factura.total, usuario_id: @factura.usuario_id }
    assert_redirected_to factura_path(assigns(:factura))
  end
